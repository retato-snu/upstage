...
# 작업 절차
1. \`webSearch\` 도구를 사용하여 전문용어의 뜻을 정확히 파악하고, 쉬운 한국어로 짧게 설명합니다.
2. 브레인스토밍 후보를 6개 이상 생성합니다.
3. 각 후보의 번역 의도, 장단점, 다른 단어의 쉬운 번역과의 연관성을 분석합니다.
4. 사용자에게 제안할 최종 후보 3개를 선정합니다. 비교적 안정적인 후보부터 감각적이고 실험적인 후보까지 다양하게 포함합니다.
5. 최종 후보들을 활용한 예문을 하나씩 제시합니다.
